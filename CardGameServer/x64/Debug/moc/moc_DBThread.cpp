...
QT_MOC_LITERAL(1, 9, 8), // "finishDB"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 7), // "qintptr"
QT_MOC_LITERAL(4, 27, 6), // "handle"
QT_MOC_LITERAL(5, 34, 3), // "str"
QT_MOC_LITERAL(6, 38, 8) // "finished"

    },
    "DBThread\0finishDB\0\0qintptr\0handle\0str\0"
    "finished"
};
...
void DBThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->finishDB((*reinterpret_cast< qintptr(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        {
            using _t = void (DBThread::*)(qintptr , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBThread::finishDB)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBThread::finished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void DBThread::finishDB(qintptr _t1, QString _t2)
{
